...
attachment_file_name = GenerateAttachmentFilePath()
...
class Task(models.Model):
    ...
    completed_by = models.ForeignKey('users.profile', null=True, blank=True, on_delete=models.SET_NULL, related_name='created_tasks')
...
class Attachment(models.Model):
    ...
    data = models.FileField(upload_to=attachment_file_name)
