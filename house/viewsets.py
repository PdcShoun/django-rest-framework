...
class HouseViewSet(viewsets.ModelViewSet):
    ...
    permission_class = [IsHouseManagerOrNone, ]
    serializer_class = HouseSerializer

    @action(detail=True, method=['post'], name='Join', permission_class=[])
    ...
    @action(detail=True, methods=['post'], name='Leave', permission_class=[])
